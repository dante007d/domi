    ...
    const Game = {
      ...
      showLevelSelect() {
        ...
        let maxUnlocked = 11;
        try {
            maxUnlocked = parseInt(localStorage.getItem('domi_unlocked_level') || '11');
        } catch (e) {
        ...
        render(container) {
          ...
          container.innerHTML = `
                        <div class="terminal-block zone-2-theme" style="position:relative;">
                            ...
                            <pre class="code-block" style="border-left-color:var(--ouro-emerald); white-space: pre-wrap; font-family: 'JetBrains Mono', monospace; text-align: left; margin: 15px 0; font-size: 0.9rem;">${q.q}</pre>
